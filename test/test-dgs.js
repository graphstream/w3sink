(function(exports) {
    ...
    exports.asyncTest('asynchronous test: Test graph loading', function() {
        ...
        function after_graph_loaded(source) {
            ...
            exports.test("Test number of steps", function(){
              exports.ok(nbSteps === 6, 'Problem with the number of steps');
            });

            exports.test("Test nodes and edges creation/deletion", function() {
                exports.ok(graph.nodes['1'].id === '1', 'Node ids are not ok');
                exports.ok(graph.nodesCount === 4, 'Problem with the number of nodes');
                exports.ok(graph.edgesCount === 3, 'Problem with the number of edges');
                ...
                exports.ok(graph.edgesCount <= 3, 'Problem with the number of nodes. Maybe something with edge deletion');
        ...
        var promise = source.begin('graph.dgs');
        promise.then(after_graph_loaded, function(err){
          exports.ok(false, 'promise didn\'t resolve. DGS loading failed.');
        });
    });
})(this);
