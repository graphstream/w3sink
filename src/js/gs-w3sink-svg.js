(function(exports) {
	...
	function SVGEdge(graph, id, source, target, directed) {
		GS.Edge.call(this, graph, id, source, target, directed);
	...
	GS.extend(GS.Node.prototype, SVGNode.prototype);
	GS.extend(GS.Edge.prototype, SVGEdge.prototype);
	...
	exports.GS.extend(GS.Context.prototype, SVGContext.prototype);
